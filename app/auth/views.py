...
from app.auth.utils import save_session_data, remove_single_user_session_by_user_id_hash
...
def login():
    ...
    try:
        ...
        access_token = controller._create_access_token(
