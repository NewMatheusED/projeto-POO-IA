...
class UserRegistrationSchema(Schema):
    ...
    name = fields.Str(required=True, validate=validate_name, error_messages={"required": "Nome é obrigatório", "invalid": "Nome inválido"})

    email = fields.Str(required=True, validate=validate_email, error_messages={"required": "Email é obrigatório", "invalid": "Email inválido"})

    password = fields.Str(required=True, validate=validate_password, error_messages={"required": "Senha é obrigatória", "invalid": "Senha inválida"})
...
class UserLoginSchema(Schema):
    ...
    password = fields.Str(required=True, validate=[validate.Length(min=1, max=100)], error_messages={"required": "Senha é obrigatória"})
