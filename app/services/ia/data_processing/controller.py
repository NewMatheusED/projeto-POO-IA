...
from app.services.ia.data_processing.pipeline import BatchProcessingPipeline, DataProcessingPipeline, PipelineFactory
from app.services.ia.data_processing.schemas import ProcessingRequestSchema
...
class DataProcessingController:
    ...
    def process_single_item(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "data": result, "record_id": result.get("record_id"), "processing_time": processing_time}
            ...
            processing_time = time.time() - start_time
            return {"success": False, "error": f"Erro inesperado: {str(e)}", "processing_time": processing_time}
    ...
    def process_batch(self, items: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Erro no processamento em lote: {str(e)}", "processed_count": 0, "failed_count": len(items)}
