...
from app.services.ia.interfaces import AIClient, AIMessage, AIConnectionError, AIAuthenticationError, AIServiceError
from app.services.ia.models import AIResponse
    ...
    def _create_client(self) -> ChatCompletionsClient:
        ...
        try:
            ...
            return ChatCompletionsClient(
                ...
                credential=AzureKeyCredential(self._config.token)
            )
